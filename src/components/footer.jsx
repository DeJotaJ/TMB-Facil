export default function Footer(){
    return(
        <>
            <div className="min-h-[5vh] w-full px-4 py-4 gap-4 fixed bottom-0 flex flex-col justify-between items-center text-sm  bg-[#222831] text-[#E5E5E5] 
                            md:h-[10vh] md:px-20 md:relative md:flex-row md:justify-center md:gap-24 md:text-lg md:font-light           
            ">
                ...
                <nav className="w-1/2 md:w-2/3 flex-col"> 
                    <ul className="w-full flex justify-center flex-wrap gap-1 md:gap-12 font-semibold">
